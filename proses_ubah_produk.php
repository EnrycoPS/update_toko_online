...
if($_POST){
    ...
    if(empty($nama_produk)){
        ...
        echo "<script>alert('nama_produk produk tidak boleh kosong');location.href='ubah_produk.php';</script>";
        ...
        echo "<script>alert('foto_produk tidak boleh kosong');location.href='ubah_produk.php';</script>";
